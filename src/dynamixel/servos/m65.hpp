#ifndef DYNAMIXEL_SERVOS_M65_HPP_
#define DYNAMIXEL_SERVOS_M65_HPP_
...
namespace dynamixel {
    namespace servos {
        ...
        class M65 : public Servo<M65> {
        public:
            typedef M65 Model;

            M65(typename protocol_t::id_t id) : Servo<M65>(id){};
